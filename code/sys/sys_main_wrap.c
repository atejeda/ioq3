...
/*-----------------------------------------------
  ...
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__sys_main

#else
#  define SWIG_init    init_sys_main

#endif
#define SWIG_name    "_sys_main"
...
SWIGINTERN PyObject *_wrap_pymain(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  int arg1 ;
  char **arg2 = (char **) 0 ;
  int val1 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:pymain",&obj0,&obj1)) SWIG_fail;
  ecode1 = SWIG_AsVal_int(obj0, &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "pymain" "', argument " "1"" of type '" "int""'");
  } 
  arg1 = (int)(val1);
  {
    /* Check if is a list */
